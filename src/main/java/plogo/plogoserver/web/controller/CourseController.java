...
public class CourseController {
    ...
    public ApiResponse<List<CourseResponseDTO>> coursesFromArea(
        ...
        //임시 유저값
        List<CourseResponseDTO> courses = courseService.getByAreaName(areaCode);
...
//    }
    ...
    public ApiResponse<List<CourseResponseDTO>> analyzePreference(
        ...
        return ApiResponse.onSuccess(courseService.analyzePreference(requestBody));
    }
    ...
    public ApiResponse<List<CourseResponseDTO>> recommendCourse(
        ...
        List<CourseResponseDTO> recommendCourses = courseService.getRecommendCourse();
    ...
    public ApiResponse<CourseDetailDTO> courseDetail(
        ...
        //임시 유저값
        CourseDetailDTO course = courseService.getCourseDetail(course_id);
    ...
    public ApiResponse<SaveStatusDTO> saveCourse(
        ...
        SaveStatusDTO dto = courseService.toggleSaveCourse(course_id);
    ...
    public ApiResponse<LogIdDTO> completeCourse(
        ...
        return ApiResponse.onSuccess(LogIdDTO.builder()
                .logId(courseService.completeCourse(course_id)).build());
    }
    ...
    public ApiResponse<List<CourseResponseDTO>> getSaveCourse(
        ...
        return ApiResponse.onSuccess(courseService.getSaveCourse());
    }
    ...
    public ApiResponse<List<CourseResponseDTO>> getCompleteCourse(
        ...
        return ApiResponse.onSuccess(courseService.getCompleteCourse());
    }
    ...
    public ApiResponse<List<CourseResponseDTO>> getHotCourses(
        ...
        return ApiResponse.onSuccess(courseService.getHotCourses());
    }
...
//    }
    ...
    public ApiResponse<List<CourseResponseDTO>> getRecentCourse(
        ...
        return ApiResponse.onSuccess(courseService.getRecentCourse());
    }
    ...
    public ApiResponse<List<CourseResponseDTO>> getSigunguCourse(
        ...
        return ApiResponse.onSuccess(courseService.getSigunguCourse(sigunguId));
    }
